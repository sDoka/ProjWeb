...
function place_mark(name,val)
{
    
    myCollection.removeAll();
    var x = new String("");
    var y = new String("");
    coordx = document.getElementById(name).value;
    coordy = document.getElementById(name).name;
    ...
    var point = { coords: [x, y] };
    myCollection.add(myPlacemark = new ymaps.Placemark(
	            point.coords, {
	                balloonContent: val
	            }, {
	                draggable: false,
...
function search_map_admin() 
{
    myPoints = [
        ...
        { coords: [59.989188, 30.315621], text: 'второй', adress: 'Невский 33', tel: '135235412', email: 'sdsg@sap.com', telm: '568345356' },
        { coords: [59.989188, 30.315622], text: 'Третий', adress: 'Невский 33', tel: '135235412', email: 'sdsg@sap.com', telm: '568345356' }
    ];
